            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                            <%ArrayList<clothe_bean> clothe_bean= (ArrayList)request.getAttribute("clothe_bean");
                                   if(clothe_bean!=null){ %>
                                <center class="m-t-30">
                                    <h4 class="card-title m-t-10"><%=clothe_bean.get(0).getClotheName() %></h4>
                                    <h6 class="card-subtitle">Accoubts Manager Amix corp</h6>
                                    <div class="row text-center justify-content-md-center">
                                        <div class="col-4"><a href="javascript:void(0)" class="link"><i class="icon-people"></i> <font class="font-medium">254</font></a></div>
                                        <div class="col-4"><a href="javascript:void(0)" class="link"><i class="icon-picture"></i> <font class="font-medium">54</font></a></div>
                                    </div>
                                    <img style="margin-top:50px;" width=80%; height=60%;  src="<%=clothe_bean.get(0).getClotheImg() %>">
                                </center>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="clothe_modify?ID=<%=clothe_bean.get(0).getClotheId() %>&img=<%=clothe_bean.get(0).getClotheImg() %>" class="form-horizontal form-material" enctype="multipart/form-data" method =post>
                                    <div class="form-group">
                                        <label class="col-md-12">衣服名字</label>
                                        <div class="col-md-12">
                                            <input type="text" name="ClotheName" value="<%=clothe_bean.get(0).getClotheName()%>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div style="margin-top:75px;" class="form-group">
                                        <label class="col-md-12">衣服价格</label>
                                        <div class="col-md-12">
                                            <input type="text" name="ClothePrice" value="<%=clothe_bean.get(0).getClothePrice() %>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                     <div style="margin-top:75px;" class="form-group">
                                        <label class="col-md-12">衣服类型</label>
                                        <div class="col-md-12">
                                            <input type="text" name="Clothetype" value="<%=clothe_bean.get(0).getClothetype()%>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    
                                     <div style="margin-top:75px;" class="form-group">
                                        <label class="col-md-12">衣服图片(如需修改请点击)</label>
                                        <div class="col-md-12">
                                            <input type="file" name="ClotheImg" value="<%=clothe_bean.get(0).getClotheImg() %>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    
                                    <div style="margin-top:75px;" class="form-group">
                                        <label class="col-md-12">衣服生产地址</label>
                                        <div class="col-md-12">
                                            <input type="text" name="ClothefactoryAddress" value="<%=clothe_bean.get(0).getClothefactoryAddress() %>" class="form-control form-control-line">
                                        </div>
                                    </div>
