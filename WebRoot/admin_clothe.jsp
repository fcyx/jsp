            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">商品列表</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li  class="breadcrumb-item active"><a href="login_look_servlet">clother</a></li>
                            </ol>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="card-title">衣服信息</h5>
                                        <h6 class="card-subtitle">你猜猜有多少用户？ </h6>
                                    </div>
                                    
                                </div>
                                <div><a href="upclothe.jsp"><button style="background-color: #9C0; color:#FFF; font-size:20px; ">上传衣服信息</button></a></div>
                               <form action="queryServlet?&table=clothe_information" method=post>
									<div class="abcd">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                   ...
                                   if(clothe_bean!=null){
     								 for(int i=0;i<clothe_bean.size();i++){%>
                                        <tr>
                                            <td class="text-center"><%=clothe_bean.get(i).getClotheId()%></td>
                                            <td class="txt-oflo"><a href="clothe_details?ID=<%=clothe_bean.get(i).getClotheId()%>"><%=clothe_bean.get(i).getClotheName() %></a></td>
                                            <td class="txt-oflo"><%=clothe_bean.get(i).getClothePrice() %></td>
                                            <td><span class="txt-oflo"> <%=clothe_bean.get(i).getClothetype() %> </span></td>
                                            <td><span class="txt-oflo"> <%=clothe_bean.get(i).getClothefactoryAddress() %> </span></td>
                                            <td class="text-success"> <a href="delete_user?ID=<%=clothe_bean.get(i).getClotheId()%>&table=clothe_information">删除商品</a></td>
                                        </tr>
                                        <%}} %>
                                    </tbody>
                                </table>
