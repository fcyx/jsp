		...
		<!-- 轮播（Carousel）指标 -->
	        ...
	        <div style=" padding: 0px;margin: 0px;" class="col-lg-4">
				    ...
				    <div style=" margin-top: 20px;"> 
				    	...
				    	<img width="183px;" height="75px" src="nanclotherImg/sos3.jpg">
				    	<img width="183px;" height="75px" src="nanclotherImg/sos4.jpg">
		...
		<div class="row">
	    	<div  class="col-lg-12">
	        	<ul  style="background-color: #CFF;" class="nav nav-pills nav-justified">
	                ...
	                <li class="active"><a class="ayf" href="chun?dataBase=people_information&tableName=clothe_information">春装</a></li>
