                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li  class="breadcrumb-item active"><a href="login_look_servlet">loginers</a></li>
                            </ol>
                            <a class="btn btn-success d-none d-lg-block m-l-15" href="login_look_servlet"> Upgrade To Pro</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div><a href="reg.jsp"><button style="background-color: #9C0; color:#FFF; font-size:20px; ">增加用户</button></a>
                                
                                	 <form  action="login_look_servlet" method=post>
										<div class="abcd">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                   <%ArrayList<reg> reg= (ArrayList)request.getAttribute("reg");
                                   
                                   if(reg!=null){
     								 for(int i=0;i<reg.size();i++){%>
                                        <tr>
                                            <td class="text-center"><%=reg.get(i).getID() %></td>
                                            <td class="txt-oflo"><a href="user_information?ID=<%=reg.get(i).getID()%>"><%=reg.get(i).getName() %></a></td>
                                            <td class="txt-oflo"><%=reg.get(i).getUserName() %></td>
                                            <td><span class="txt-oflo"> <%=reg.get(i).getPassword() %> </span></td>
                                            <td class="text-success"> <a href="delete_user?ID=<%=reg.get(i).getID() %>&table=reg">删除用户</a></td>
                                        </tr>
                                        <%}} %>
                                    </tbody>
                                </table>
