                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="admin_clothe"><button type="button" class="btn btn-success d-none d-lg-block m-l-15"> Upgrade To Pro</button></a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center class="m-t-30">
                                    <h4 class="card-title m-t-10">上传衣服信息</h4>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="card-body">
                             	<center>
  		<h3>上传衣服信息</h3>
	    <form method="post" name="a" id ="a" action="Upclothe" enctype="multipart/form-data">
	   		<table>
		   		<tr>
		   			<td>衣服名称</td>
			    	<td><input type="text" name = "ClotheName"  ></td>
			    </tr>
			    <tr>
		   			<td>衣服价格</td>
			    	<td><input type="text" name = "ClothePrice"  ></td>
			    </tr>
			    <tr>
		   			<td>衣服类型：</td>
			    	<td><input type="text" name = "Clothetype"  ></td>
			    </tr>
			    <tr>
		   			<td>上传衣服图片:</td>
			    ...
			    <tr>
		   			<td>衣服出厂地址</td>
			    	<td><input type="text" name = " ClothefactoryAddress"  ></td>
			    </tr>
